...
from evidential_regression.training.losses import evidential_regression
from evidential_regression.models.early_stopping import EarlyStopper
from evidential_regression.training.train_eval import train_and_val_proc
...
def ffnn_objective(trial: optuna.Trial) -> float:
    ...
    lamb_loss = trial.suggest_float("loss_lamb", 0.001, 0.1, log=True)
...
def run_optuna(n_trials: int = 100, output_dir: Path = None):
    ...
    study = optuna.create_study(
        study_name="ffnn_evidential_tuning",
